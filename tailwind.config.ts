...
export default {
  content: ["./src/app/**/*.{ts,tsx}", "./src/components/**/*.{ts,tsx}", "./src/blocks/**/*.{ts,tsx}", "./src/lib/**/*.{ts,tsx}"],
  theme: {
    extend: {
      colors: {
        cream: {
      ...
      animation: {
        ...
        "fade-in-left": "fadeInLeft 0.25s ease-out both",
        "flip-in": "flipIn 0.25s ease-out both",
