  ...
  if (!user) {
    return (
      <PageContainer className="pt-10 text-center lg:text-left">
        ...
        <Link
          href="/login"
          className="inline-block bg-brand-green text-white font-semibold rounded-pill px-5 py-2.5 text-sm transition-all duration-200 ease-smooth hover:bg-brand-greenDark hover:shadow-hover hover:-translate-y-0.5"
        >
          Log in
        </Link>
      </PageContainer>
    ...
    <PageContainer className="pt-5">
      ...
      <div className="bg-navy rounded-card p-5 lg:p-7 text-white animate-fade-in-up">
        <div className="flex items-center gap-3">
          <span className="w-12 h-12 rounded-full bg-brand-orange flex items-center justify-center font-display font-bold text-lg">
      ...
      <div className="mt-6">
        <Link
          href="/my-space/wallet"
          className="flex items-center justify-center gap-2 text-center bg-brand-orange text-white font-semibold rounded-pill px-5 py-3 transition-all duration-200 ease-smooth hover:bg-brand-orangeDark hover:shadow-hover hover:-translate-y-0.5 active:translate-y-0"
        >
