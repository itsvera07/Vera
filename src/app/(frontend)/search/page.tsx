    ...
    <>
      ...
      <PageContainer>
        ...
        {query && totalResults === 0 && (
          <p className="text-sm text-ink-muted">No results for "{query}". Try a different word.</p>
        )}
                ...
                return (
                  <ScrollReveal key={lesson.id} delay={i * 0.04}>
                    <TiltLink
                      ...
                      className="bg-white rounded-card p-4 shadow-card flex items-center justify-between transition-shadow duration-300 hover:shadow-hover"
                    >
                      <div>
              ...
              {books.map((book: any, i: number) => (
                <ScrollReveal key={book.id} delay={i * 0.04}>
                  <TiltLink
                    ...
                    className="bg-white rounded-card shadow-card p-3 transition-shadow duration-300 hover:shadow-hover"
                  >
              ...
              {chats.map((chat: any, i: number) => (
                <ScrollReveal key={chat.id} delay={i * 0.04}>
                  <TiltLink
                    ...
                    className="bg-white rounded-card p-4 shadow-card flex items-center gap-3 transition-shadow duration-300 hover:shadow-hover"
                  >
