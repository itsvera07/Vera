      ...
      <PageContainer>
        ...
        {hasAccess ? (
          <div className="lg:max-w-2xl animate-fade-in-up" style={{ animationDelay: "60ms" }}>
            ...
            {nextChapter ? (
              <a href={`/stories/${book.slug}/${nextChapter.slug}`} className="block text-center bg-brand-orange text-white font-semibold rounded-pill px-5 py-3 mt-4 transition-all duration-200 ease-smooth hover:bg-brand-orangeDark hover:shadow-hover hover:-translate-y-0.5 active:translate-y-0">
                Next Chapter →
              </a>
            ) : (
