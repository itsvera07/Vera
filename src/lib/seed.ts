...
async function seed() {
  ...
  const talkingInSchool = await payload.create({
    ...
    data: {
      ...
      shortDescription:
        'Find your voice with classmates, teachers, and new friends — from your first day to your final presentation.',
      icon: 'users',
      cardColor: 'peach',
      order: 1,
      featured: true,
  ...
  await payload.create({
    ...
    data: {
      ...
      orderInTopic: 2,
      content: [
        { blockType: 'intro', body: 'A simple trick to make names stick the first time.' },
      ],
    },
  })
  ...
  await payload.create({
    ...
    data: {
      ...
      orderInTopic: 3,
      content: [
        { blockType: 'intro', body: 'How to step into a conversation without interrupting it.' },
      ],
    },
  })
  ...
  await payload.create({
    ...
    data: {
      ...
      content: [
        { blockType: 'intro', body: 'The exact words for a new lunch table, with none of the small-talk stiffness.' },
      ],
    },
  })
      ...
      body: {
        root: {
          ...
          children: [
            {
              type: 'paragraph',
              children: [{ type: 'text', text: 'The note was tucked under the wiper blade, corners flapping in the wind.', format: 0 }],
            },
          ],
        },
      },
      ...
      body: {
        root: {
          ...
          children: [
            {
              type: 'paragraph',
              children: [{ type: 'text', text: 'She read it twice before she let herself smile.', format: 0 }],
            },
          ],
        },
      },
